...
@section('rightcol_content_lvl2')
            ...
            @foreach($gamedaylist as $gameday)
                <tr>
                    ...
                    <td>
                        ...
                        @can('manage-gamedays')
                        <a href="/gamedays/{{$gameday->id}}/edit"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                        @endcan
                    </td>
                </tr>
            @endforeach
    ...
    {!! Form::submit('Neuen Spieltageintrag erstellen', ["class" => "btn btn-default"]) !!}
    {!! Form::close() !!}
    @endcan
@stop